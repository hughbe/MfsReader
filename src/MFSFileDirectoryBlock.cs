...
public struct MfsFileDirectoryBlock
{
    ...
    public MfsFileDirectoryBlock(ReadOnlySpan<byte> data, out int bytesRead)
    {
        ...
        FolderNumber = BinaryPrimitives.ReadInt16BigEndian(data.Slice(offset, 2));
        offset += 2;
        ...
        DataForkAllocationBlock = BinaryPrimitives.ReadUInt16BigEndian(data.Slice(offset, 2));
        offset += 2;

        // fILgLen (long word) logical end-of-file of data fork
        // Data fork size, in bytes.
        DataForkSize = BinaryPrimitives.ReadUInt32BigEndian(data.Slice(offset, 4));
        offset += 4;
        ...
        DataForkAllocatedSize = BinaryPrimitives.ReadUInt32BigEndian(data.Slice(offset, 4));
        offset += 4;
        ...
        ResourceForkAllocationBlock = BinaryPrimitives.ReadUInt16BigEndian(data.Slice(offset, 2));
        offset += 2;

        // fIRLgLen (long word) logical end-of-file of resource fork 
        // Resource fork size, in bytes.
        ResourceForkSize = BinaryPrimitives.ReadUInt32BigEndian(data.Slice(offset, 4));
        offset += 4;
